...
from app.models.enums import AdvertisementStatus, AssetStatus, AssetType
...
async def _get_owned_advertisement(db: AsyncSession, user: User, advertisement_id: uuid.UUID) -> Advertisement:
    result = await db.execute(
        ...
        .options(selectinload(Advertisement.assets).selectinload(AdvertisementAsset.renditions))
